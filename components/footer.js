export default function Footer() {
  ...
  return (
    <footer className="flex justify-between py-3 pl-6 pr-6 items-center bg-gray-700 text-white text-sm md:p-6 mt-4">
      ...
      <div className=" flex space-x-2 md:space-x-6">
        ...
        <a href="https://www.facebook.com/csajpage" target="_blank" rel="noopener noreferrer">
          <img className="h-8 w-12 md:h-10 md:w-auto" src="/facebook.png" alt="Facebook" />
        </a>
        <a href="https://t.me/+edmi4r6uHZU0NmVl" target="_blank" rel="noopener noreferrer">
          <img className="md:h-10 w-14 md:w-auto flex justify-center" src="/telegram.png" alt="Telegram" />
        </a>
      </div>
    </footer>
  );
