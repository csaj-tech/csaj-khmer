    ...
    return (
        <section className="w-max-fit px-2 text-red-700 bg-white">
            <div className="flex flex-col flex-wrap items-center justify-between py-6 mx-auto md:flex-row max-w-7xl ">
                ...
                <div className="inline-flex items-center justify-end xl:ml-5">
                    ...
                    <a href="https://forms.gle/UYriTnL1JzHnPzyU6" className="font-medium inline-flex tracking-tighter uppercase text-xl items-center sm:mt-0 mt-5 sm:ml-8 justify-center px-5 py-2.5  text-white bg-red-500 border border-transparent rounded-md shadow-sm hover:bg-red-400  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Join Us</a>
                </div>
