                ...
                <section>
                    <div className="flex flex-col max-w-6xl px-3 mx-auto md:px-0 lg:px-8 xl:px-0 md:flex-row py-4">
                        <div className="w-full pr-5 mb-6 space-y-1 md:mb-0 md:space-y-4 md:w-4/12 xl:pr-12">
                            <h2 className="pb-2 text-center text-3xl font-extrabold cursor-pointer lg:text-4xl text-gray-800">Working part-time as a student</h2>
                        </div>

                        <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Applying for the work permit</h3>
                                ...
                                <ol class="list-inside list-decimal" className='px-5 md:px-0 text-left md:text-justify text-gray-700'>
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Working limitations and restricted jobs </h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
                                ...
                                <ul class="list-inside list-disc" className='px-5 md:px-0 text-left md:text-justify text-gray-700'>
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Possible English-speaking jobs</h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Be aware of scams!</h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
                    ...
                    <div className="flex flex-col max-w-6xl px-3 mx-auto md:px-0 lg:px-8 xl:px-0 md:flex-row py-4">
                        <div className="w-full pr-5 mb-6 space-y-1 md:mb-0 md:space-y-4 md:w-4/12 xl:pr-12">
                            <h2 className="pb-2 text-center text-3xl font-extrabold cursor-pointer lg:text-4xl text-gray-800">Full-time jobs after graduation</h2>
                        </div>

                        <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Recruitments</h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Knowing Japanese is a huge advantage</h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Japanese work permit</h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Certificate of Eligibility</h3>
                                <p className="px-5 md:px-0 text-base font-normal leading-[20px] md:leading-none text-gray-700 md:text-lg text-left md:text-justify">
