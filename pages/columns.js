...
export default function Columns() {
  ...
  let currentPosts = allColumnsData.slice(indexOfFirstPost, indexOfLastPost);
      ...
      <section className="w-full py-10 bg-white font-sans">
        ...
        <div className="px-8 py-10 mx-auto lg:max-w-screen-xl sm:max-w-xl md:max-w-full sm:px-12 md:px-16 lg:py-20 sm:py-16">
          ...
          <div className="flex justify-center mt-4">
            ...
            <button className="mx-1 px-3 py-2 bg-blue-600 text-white" onClick={() => paginate(currentPage < Math.ceil(allColumnsData.length / postsPerPage) ? currentPage + 1 : currentPage)}>Next</button>
          </div>
        </div>
      </section>
    </Layout>
