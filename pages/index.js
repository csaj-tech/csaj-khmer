      ...
      <>
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/3 px-16">
            <h1 className="text-4xl text-center md:text-4xl lg:text-5xl md:text-left font-sans mb-8 relative text-blue-600 font-bold">
              Cambodian Students' Association in Japan
            </h1>
            <p className="mb-4 font-sans text-left text-lg md:text-xl  lg:text-xl md:text-justify">
              ...
              Japan, including Kanto, Kansai, Nagoya, Hiroshima, and Kyushu. We
              aim to build a community of collective support, exchanges of
            ...
            <div className="p-4 mt-10 md:p-8 bg-white rounded-lg text-center">
              ...
              <div className="mb-4">
                <p className="font-sans text-left md:text-justify text-lg">
                  ...
                  association composed entirely of Cambodians pursuing academia
                  in Japan. As we are a nonprofit organization, we require
                  ...
                  maintain good communication with Cambodian students and
                  foreign correspondents in order to successfully carry out our
                  missions. Your invaluable help will allow CSAJ to provide
                  comfort and shelter to Cambodian students in Japan as well as
                  to strengthen the relationship between Cambodian and Japanese
                  and other foreign communities, providing solidarity to
            ...
            <div className="p-4 md:p-8 bg-white rounded-lg text-center">
              ...
              <div className="py-6 font-sans text-left md:text-justify text-lg">
                ...
                <ul className="list-inside list-decimal ">
                  <li>
                    {" "}
                    <b>Newsletter</b>: 440 subscription with average readership
                    of 200 readers as of January 2023.{" "}
                  </li>
                  <li>
                    {" "}
                    <b>Social network</b>: 17,401 Facebook followers, 3,025
                    Facebook group members and 50 Telegram channel subscribers
                    as of March 2023.{" "}
                  </li>
                  <li>
                    {" "}
                    <b>Students community</b>: access to large and vibrant
                    communities of Cambodian students in Kanto, Kansai, and
                    Kyushu regions as well as Hiroshima and Nagoya prefectures.{" "}
                  </li>
                  <li>
                    {" "}
