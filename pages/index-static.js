            ...
            <div className="flex max-w-full flex-row lg:flex-row space-x-24 relative mx-auto py-2 lg:py-2 px-16 lg:px-16">
              <div className="w-1/2 lg:w-1/2 w-full lg:max-w-none max-w-2xl relative flex items-start justify-center flex-col">
                ...
                <p className="font-sans text-justify text-lg">
                  ...
                  behalf of the Cambodian students studying in all main regions
                  of Japan, including Kanto, Kansai, Nagoya, Hiroshima, and
                  Kyushu. We aim to build a community of collective support,
                  exchanges of ideas, knowledge and friendship among the
                  Cambodian students in Japan for the social prosperity in
                  general.
                </p>
