                ...
                <section>
                    <div className="flex flex-col max-w-6xl px-3 mx-auto md:px-0 lg:px-8 xl:px-0 md:flex-row py-4">
                        <div className="w-full pr-5 mb-6 space-y-1 md:mb-0 md:space-y-4 md:w-4/12 xl:pr-12">
                            <h2 className="pb-2 text-center text-3xl font-extrabold cursor-pointer lg:text-4xl text-gray-800">Reasons to Study in Japan</h2>
                        </div>

                        <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0  text-2xl font-bold leading-7 text-gray-600">World-class education</h3>
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Rich Culture and Tradition</h3>
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Cuisine</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Safe and Welcoming Environment</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Career Opportunities</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                    ...
                    <div className="flex flex-col max-w-6xl px-3 mx-auto md:px-0 lg:px-8 xl:px-0 md:flex-row py-4">
                        <div className="w-full pr-5 mb-6 space-y-1 md:mb-0 md:space-y-4 md:w-4/12 xl:pr-12">
                            <h2 className="pb-2 text-center text-3xl font-extrabold cursor-pointer lg:text-4xl text-gray-800">Before Coming Here</h2>
                        </div>

                        <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Academic Programs</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Language</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Documentation</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Budgeting and Finance</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                    ...
                    <div className="flex flex-col max-w-6xl px-3 mx-auto md:px-0 lg:px-8 xl:px-0 md:flex-row py-4">
                        <div className="w-full pr-5 mb-6 space-y-1 md:mb-0 md:space-y-4 md:w-4/12 xl:pr-12">
                            <h2 className="pb-2 text-center text-3xl font-extrabold cursor-pointer lg:text-4xl text-gray-800">Student Life in Japan</h2>
                        </div>
                        ...
                        <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
                            ...
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Culture</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Living Expense</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
                            ...
                            <div className="w-full space-y-6 text-gray-700 pb-8" >
                                <h3 className="px-5 md:px-0 text-2xl font-bold leading-7 text-gray-600">Having a Concrete Emotional Support System</h3>
                                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left md:text-justify">
