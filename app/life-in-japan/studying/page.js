            ...
            <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
              ...
              <div className="w-full space-y-6 pb-8">
                ...
                <p className="px-5 md:px-0  text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  that is steeped in tradition, history and art.
                </p>
              </div>
              ...
              <div className="w-full space-y-6 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  paste soup) and protein like fish, making it a well-balanced
                  meal. Maintaining a healthy diet is crucial when studying
                  abroad as it provides you necessary nutrients and energy to
                  stay focused and perform well academically.
                </p>
              </div>
            ...
            <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  most of the opportunities can be found on the Embassy of Japan
                  in Cambodia homepage. Intensive research and gathering
                  information from different sources such as the internet,
                  family, friends, teachers and acquaintances, can also be
                  beneficial. Once you have selected the appropriate program,
                  the application process is the next step. To ensure a
                  successful application, it is crucial to plan ahead, carefully
                  review all requirements, and be mindful of deadlines.
                </p>
              </div>
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  majority of the population still do not speak English. Picking
                  up a new language might sound scary, but it might be the most
                  exciting part about studying abroad. Learning Japanese will
                  not only benefit you academically and in everyday life, but it
                  will also give you a chance to deepen your understanding about
                  the culture itself, as well as feeling more connected to the
                  country. You can start from studying Hiragana, Katakana and
                  some often used Kanjis to familiarize yourself with the
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  certificate, school diploma and transcripts (translated in
                  English), in order to apply for Student Visa and Certificate
                  of Eligibility. Booking flight tickets early might be also a
                  good idea too during this process to get the best price.
                </p>
              </div>
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  might vary from schools and majors, but you can estimate the
                  amount by using{" "}
                  <a
                    className="underline dark:text-blue-500 hover:no-underline"
                    href="https://www.studyinjapan.go.jp/en/planning/academic-fees/"
                  >
                    this
                  </a>{" "}
                  as a reference. While most schools offer full and partial
                  scholarships especially to international students, it is
                  better to make a financial plan and secure some money enough
                  to make sure that you can live comfortably and afford basic
            ...
            <div className="relative w-full mt-6 overflow-hidden md:mt-1 md:w-9/12">
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  students in Japan are also involved in extracurricular
                  activities which we called “部活Bukatsu” ranging from sports,
                  arts to research and volunteering. This can also act as a
                  platform for students to make new friends and build
                  connections balancing study and social life.
                </p>
              </div>
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  your teachers and your peers, and be punctual.
                </p>
              </div>
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  track of your expenses and always prepare some fund at least
                  50,000 JPY in case of emergency. More information in the
              ...
              <div className="w-full space-y-6 text-gray-700 pb-8">
                ...
                <p className="px-5 md:px-0 text-base font-normal md:leading-none text-gray-700 md:text-lg leading-[20px] text-left">
                  ...
                  when you feel homesick, burnout, and moments when you feel
                  like giving up, however, these struggling times are when you
                  grow the most. Therefore, having an emotional support system
                  is essential to keep your mental health in check. This kind of
                  support can come from your family, friends, mentors, advisors
                  or counselors, and last but not least, from the Cambodian
                  Students’ Association in Japan. Hopefully, by communicating
                  your struggles and concerns, it can help you cope with those ,
                  or at least having an outlet where you can express yourself
                  and feel heard. Remember, seeking support is a sign of
